		...
		return (
			<Card text="dark">
				<Card.Body>
					...
					<Card.Text>
T	he preferred way of contributing is to create an issue on GitHub. You do not need any programming knowledge to do this. All you need is an email to create an account.
					</Card.Text>
					<Button variant="secondary" href="https://github.com/SASE-Labs-2020/SASE-Labs-2020.github.io/issues/new">Create an issue</Button>
					<Card.Text>
I	f you do not want to create a GitHub account, you may submit an anonymous Google form.
					</Card.Text>
